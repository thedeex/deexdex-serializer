...
Types.public_key = {
  toPublic(object) {
    ...
    return object == null ? object : object.Q ? object : _deexdexEcc.PublicKey.fromStringOrThrow(object);
  },
  ...
  toObject(object, debug = {}) {
    if (debug.use_default && object === undefined) {
      return (0, _deexdexEcc.getAddressPrefix)() + "859gxfnXyUriMgUeThh1fWv3oqcpLFyHa3TfFYC4PK2HqhToVM";
    }
...
Types.address = {
  _to_address(object) {
    ...
    return _deexdexEcc.Address.fromString(object);
  },

  fromByteBuffer(b) {
    return new _deexdexEcc.Address(_FastParser.default.ripemd160(b));
  },
  ...
  toObject(object, debug = {}) {
    if (debug.use_default && object === undefined) {
      return (0, _deexdexEcc.getAddressPrefix)() + "664KmHxSuQyDsfwo4WEJvWpzg1QKdg67S";
    }
